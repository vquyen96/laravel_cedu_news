			...
			<div>
				<form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
		                ...
		                <img style="cursor: pointer;" id="avatar" class="cssInput thumbnail tableImgAvatar" height="300px"  src="img/image (1).png">
					</div>
					<div class="form-group">
					    <label>Tải lên</label>
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			...
			<table class="table table-hover">
				...
				<tr>	
					...
					<td >
						<a href="{{asset('admin/doc/edit/'.Request::segment(4).'/'.$item->doc_id)}}" class="btn btn-primary">Sửa</a>
